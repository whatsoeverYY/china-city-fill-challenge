...
export default function GauntletQuestionCount() {
  ...
  return <span className="question-count absolute left-[25px] top-[22px] z-[3] rounded-full border border-black/[.13] bg-paper-100/75 px-2.5 py-1.5 text-meta font-extrabold tracking-[.08em] text-stone-700 max-sm:left-3 max-sm:top-3">{label}</span>;
}
